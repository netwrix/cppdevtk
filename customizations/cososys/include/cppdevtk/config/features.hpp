...
#	ifdef NDEBUG
#		define CPPDEVTK_ENABLE_CONFIDENTIAL_INFO_IN_LOG_ENTRY_INFO 0
#	else
...
/// - old OS: Win XP SP3 target xp (Win Vista SP2 non target xp), Mac OS X 10.4 gcc (10.7 clang), Android 4.4.2 (API level 19), iOS 10
/// - new OS: Win Vista SP2 target xp (Win 7 non target xp), Mac OS X 10.5 gcc (10.10 clang), Android 4.4.2 (API level 19), iOS 10
...
#			else
//#				define CPPDEVTK_ANDROID_API 15
