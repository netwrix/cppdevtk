...
include(./test_term_sig_customization.pri)
include(./../../common.pri)
...
RESOURCES += cppdevtk_test_term_sig.qrc	\
	cppdevtk_test_term_sig_customization.qrc

win32 {
	RC_FILE = cppdevtk_test_term_sig.rc
	HEADERS += cppdevtk_test_term_sig_res_win.hpp
}
