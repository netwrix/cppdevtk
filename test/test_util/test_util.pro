...
include(./test_util_customization.pri)
include(./../../common.pri)
...
RESOURCES += cppdevtk_test_util.qrc	\
	cppdevtk_test_util_customization.qrc

win32 {
	RC_FILE = cppdevtk_test_util.rc
	HEADERS += cppdevtk_test_util_res_win.hpp
}
