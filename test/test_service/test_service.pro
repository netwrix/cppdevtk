...
include(./test_service_customization.pri)
include(./../../common.pri)
...
RESOURCES += cppdevtk_test_service.qrc	\
	cppdevtk_test_service_customization.qrc

win32 {
	RC_FILE = cppdevtk_test_service.rc
	HEADERS += cppdevtk_test_service_res_win.hpp
}
