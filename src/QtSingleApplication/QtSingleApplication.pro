...
include(./QtSingleApplicationCustomization.pri)
include(./../../common.pri)
...
# Build marker.
DEFINES *= CPPDEVTK_DETAIL_QTSINGLEAPP_BUILD
...
!debug_and_release|build_pass {
	...
	LIBS += -l$${CPPDEVTK_QTSOL_QTSINGLECOREAPPLICATION_TARGET} -l$${CPPDEVTK_QTSOL_QTLOCKEDFILE_TARGET}
...
win32 {
	RC_FILE = cppdevtk_qtsingleapplication.rc
	HEADERS += cppdevtk_qtsingleapplication_res_win.hpp
}
...
HEADERS +=	\
	../../include/cppdevtk/QtSolutions/QtSingleApplication/config.hpp	\
	../../include/cppdevtk/QtSolutions/QtSingleApplication/QtSingleApplication	\
	../../include/cppdevtk/QtSolutions/QtSingleApplication/qtsingleapplication.h
