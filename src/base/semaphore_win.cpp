...
#if (!CPPDEVTK_HAVE_WORKING_POSIX_SEMAPHORE && CPPDEVTK_PLATFORM_WINDOWS && !CPPDEVTK_ENABLE_SEMAPHORE_INTERRUPTION)
...
#endif	// (!CPPDEVTK_HAVE_WORKING_POSIX_SEMAPHORE && CPPDEVTK_PLATFORM_WINDOWS && !CPPDEVTK_ENABLE_SEMAPHORE_INTERRUPTION)
