...
#ifndef CPPDEVTK_CONFIG_PLATFORM_COMPILER_UNIX_CLANG_HPP_INCLUDED_
#define CPPDEVTK_CONFIG_PLATFORM_COMPILER_UNIX_CLANG_HPP_INCLUDED_
...
#endif	// CPPDEVTK_CONFIG_PLATFORM_COMPILER_UNIX_CLANG_HPP_INCLUDED_
