...
#ifndef CPPDEVTK_UTIL_POSIX_SIGNALS_WATCHER_UNX_HPP_INCLUDED_
#define CPPDEVTK_UTIL_POSIX_SIGNALS_WATCHER_UNX_HPP_INCLUDED_
...
class CPPDEVTK_UTIL_API PosixSignalsWatcher: public QObject, public ::cppdevtk::base::MeyersSingleton<PosixSignalsWatcher> {
	friend class ::cppdevtk::base::MeyersSingleton<PosixSignalsWatcher>;
...
#endif	// CPPDEVTK_UTIL_POSIX_SIGNALS_WATCHER_UNX_HPP_INCLUDED_
