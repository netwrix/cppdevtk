...
#ifndef CPPDEVTK_QTSOLUTIONS_QTCOPYDIALOG_QTCOPYDIALOG_H_INCLUDED_
#define CPPDEVTK_QTSOLUTIONS_QTCOPYDIALOG_QTCOPYDIALOG_H_INCLUDED_
...
class CPPDEVTK_QTCOPYDIALOG_EXPORT QtCopyDialog : public QDialog
{
    Q_OBJECT
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void error(int, ::cppdevtk::qtsol::QtFileCopier::Error, bool))
    Q_PRIVATE_SLOT(d_func(), void stateChanged(::cppdevtk::qtsol::QtFileCopier::State))
...
#endif	// CPPDEVTK_QTSOLUTIONS_QTCOPYDIALOG_QTCOPYDIALOG_H_INCLUDED_
