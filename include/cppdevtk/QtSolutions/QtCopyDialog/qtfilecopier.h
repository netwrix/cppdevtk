...
#ifndef CPPDEVTK_QTSOLUTIONS_QTCOPYDIALOG_QTFILECOPIER_H_INCLUDED_
#define CPPDEVTK_QTSOLUTIONS_QTCOPYDIALOG_QTFILECOPIER_H_INCLUDED_
...
class CPPDEVTK_QTCOPYDIALOG_EXPORT QtFileCopier : public QObject
{
    Q_OBJECT
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void copyError(int, ::cppdevtk::qtsol::QtFileCopier::Error, bool))
...
Q_DECLARE_METATYPE(cppdevtk::qtsol::QtFileCopier::State)
Q_DECLARE_METATYPE(cppdevtk::qtsol::QtFileCopier::Error)


#endif	// CPPDEVTK_QTSOLUTIONS_QTCOPYDIALOG_QTFILECOPIER_H_INCLUDED_
